...
export const setEditPromptData = (
  value: any,
  merge = true,
  insertBefore = false,
  isDeconstruct = false,
...
export const setPromptFormData = (
  value: any,
  merge = true,
  insertBefore = false,
  isDeconstruct = false,
...
export const resetEditPromptStore = () => useEditPromptStore.setState({ ...initialEditPromptData });

export const clearEditPromptStoreStorage = () => useEditPromptStore.persist.clearStorage();
